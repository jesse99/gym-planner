...
//            print(store)
    ...
    let programs = [BestButt1(), BestButt2(), BestButt3(), Bootyful3a(), Bootyful4a(), Bootyful3b(), Bootyful4b(), Bootyful4c(), Bootyful3c(), FiveThreeOneBeginner(), GlutealGoddess1(), GlutealGoddess2(), GlutealGoddess3(), GorgeousGlutes1(), GorgeousGlutes2(), GorgeousGlutes3(), HLM2(), HLM3(), IceCream(), Metallicadpa(), nSunsLP4(), nSunsLP5(), nSunsLPDead(), nSunsLPSquat(), Phat(), Phraks(), Phul(), PPLStopgap4(), PPLStopgap6(), RedditBW(), Stopgap()]   // TODO: will need to be var when we start supporting program editing
}
