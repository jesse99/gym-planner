...
//            print(store)
    ...
    let programs = [Bootyful3a(), Bootyful4a(), Bootyful3b(), Bootyful4b(), Bootyful4c(), Bootyful3c(), FiveThreeOneBeginner(), GlutealGoddess1(), GlutealGoddess2(), HLM2(), Phraks()]   // TODO: will need to be var when we start supporting program editing
}
