...
class ProgramsTabController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private func showAbout(_ program: Program) {
        ...
        view.initialize(program.description, "\(program.name) ª Description", "unwindToTagsID")
