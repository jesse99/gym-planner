...
func Bootyful4a() -> Program {
    ...
    let aExercises = ["Glute Bridge", "One Arm Row", "Box Squat", "Dumbbell Bench Press", "Dumbbell Romanian Deadlift", "Side Lying Abduction", "Front Plank", "Front Plank", "Side Plank from Knees"]
    let bExercises = ["Glute Bridge", "Lat Pulldown", "Step-up", "Dumbbell OHP", "Back Extension", "Side Lying Clam", "Crunch", "Side Crunch"]
    let cExercises = ["Glute March", "Seated Row", "Box Squat", "Dumbbell Incline Press", "Romanian Deadlift", "X-Band Walk", "RKC Plank", "Rope Horizontal Chop"]
    
    let acWarmup = ["Foam Rolling", "Hamstring Stretch", "Psoas Stretch", "Adductors", "Side Lying Abduction", "Bird-dog", "Front Plank", "LYTP", "Walking Lunge", "Wall Ankle Mobility", "Quadruped Thoracic Extension", "Rotational Lunge"]
    let bWarmup = ["Tiger Tail Roller", "SMR Glutes with Ball", "Standing Quad Stretch", "Seated Piriformis Stretch", "One-Handed Hang", "Pec Stretch", "Clam", "Side Plank", "Pushup Plus", "Wall Extensions", "Walking Knee Hugs", "Squat to Stand", "Swiss Ball Internal Rotation"]
    
    // TODO: add B warmup
    let workouts = [
        Workout("A1", aExercises, scheduled: true, optional: []),
        Workout("B",  bExercises, scheduled: true, optional: []),
        Workout("A2", aExercises, scheduled: true, optional: []),
        Workout("C",  cExercises, scheduled: true, optional: []),

        Workout("AC warmup", acWarmup, scheduled: false, optional: []),
        Workout("B warmup", bWarmup, scheduled: false, optional: []),
        ]
