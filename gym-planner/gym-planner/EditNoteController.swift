...
class EditNoteController: UIViewController, UITextViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(EditNoteController.keyboardWillShowNotification(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(EditNoteController.keyboardWillHideNotification(_:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil)
    }
    ...
    func updateBottomLayoutConstraintWithNotification(_ notification: Notification, offset: CGFloat) {
        ...
        UIView.animate(withDuration: animationDuration,
                       delay: 0.0,
                       options: UIViewAnimationOptions([.beginFromCurrentState, animationCurve]),
